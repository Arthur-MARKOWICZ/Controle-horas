...
interface UserFormValues {
  ...
  role: UserRole
  managerId: string
  standardEntryTime: string
  standardExitTime: string
...
function UsersPage() {
  ...
  const onUpdate = async (values: EditUserFormValues) => {
  ...
  const onAssignManager = async (userId: string, managerId: string) => {
