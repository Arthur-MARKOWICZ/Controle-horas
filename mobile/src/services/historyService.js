...
export const getUserOutsideScheduleWorkDays = async (userId, limit = 10, offset = 0) => (await api.get(`/api/users/${userId}/outside-schedule-work-days`, { params: { limit, offset } })).data
